...
public class Main1 {
	...
	public static void main(String[] args) {
		...
		-La classe Treballador té els atributs nom, cognom, preu/hora, i el mètode calcularSou() 
		-que rep per paràmetre el nombre d'hores treballades i el multiplica pel preu/hora. Les classes filles l'han de sobreescriure,
		-emprant @Override.
		...
		TreballadorOnline online1 = new TreballadorOnline("Adrián" , "Serra", 15);
